...
public class ItemMultiToolsArdium extends ItemPickaxe {
	public ItemMultiToolsArdium(ToolMaterial ardiumToolMaterial) {
		super(ardiumToolMaterial);
		this.setCreativeTab(Ardium.tabArdium);
		this.setTextureName(References.MOD_ID + ":ardium_multitools");
		this.setUnlocalizedName("ardium_multitools");
	}
