...
public class ItemMultiToolsPlatinum extends ItemPickaxe {

	public ItemMultiToolsPlatinum(ToolMaterial platinumToolMaterial) {
		super(platinumToolMaterial);
		this.setCreativeTab(Ardium.tabArdium);
		this.setTextureName(References.MOD_ID + ":platinum_multitools");
		this.setUnlocalizedName("platinum_multitools");
	}

	private Set<Block> effectiveAgainst = Sets.newHashSet(new Block[] { Blocks.acacia_stairs, Blocks.birch_stairs,
			Blocks.bookshelf, Blocks.brewing_stand, Blocks.brown_mushroom, Blocks.brown_mushroom_block, Blocks.cactus,
			Blocks.cake, Blocks.carrots, Blocks.cauldron, Blocks.chest, Blocks.clay, Blocks.cocoa,
			Blocks.crafting_table, Blocks.dark_oak_stairs, Blocks.daylight_detector, Blocks.deadbush,
			Blocks.detector_rail, Blocks.dirt, Blocks.double_plant, Blocks.double_stone_slab, Blocks.double_wooden_slab,
			Blocks.dragon_egg, Blocks.farmland, Blocks.fence, Blocks.fence_gate, Blocks.fire, Blocks.flower_pot,
			Blocks.glass, Blocks.glass_pane, Blocks.glowstone, Blocks.golden_rail, Blocks.grass, Blocks.gravel,
			Blocks.hardened_clay, Blocks.hay_block, Blocks.jukebox, Blocks.jungle_stairs, Blocks.ladder, Blocks.leaves,
			Blocks.leaves2, Blocks.lever, Blocks.light_weighted_pressure_plate, Blocks.lit_pumpkin, Blocks.lit_pumpkin,
			...
			Blocks.piston_extension, Blocks.piston_head, Blocks.planks, Blocks.potatoes, Blocks.powered_comparator,
			Blocks.pumpkin, Blocks.pumpkin_stem, Blocks.red_flower, Blocks.red_mushroom, Blocks.red_mushroom_block,
