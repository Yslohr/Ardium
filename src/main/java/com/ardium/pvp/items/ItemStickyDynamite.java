...
public class ItemStickyDynamite extends Item 
{
	public ItemStickyDynamite(String id) 
	{
		this.setCreativeTab(Ardium.tabArdium);
		this.setTextureName(References.MOD_ID + ":sticky_dynamite");
		this.setUnlocalizedName("sticky_dynamite");
	...
	public ItemStack onItemRightClick(ItemStack itemstack, World world, EntityPlayer entityplayer) {
		if (entityplayer.inventory.consumeInventoryItem(this)) {
			...
			if (!world.isRemote) {
				world.spawnEntityInWorld(new EntityStickyDynamite(world, entityplayer, 40 + itemRand.nextInt(10)));
			}
		}
		return itemstack;
	}
