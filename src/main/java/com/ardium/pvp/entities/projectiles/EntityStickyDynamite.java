...
public class EntityStickyDynamite extends EntityProjectile 
{
	...
	public EntityStickyDynamite(World world, double d, double d1, double d2) {
		this(world);
		setPosition(d, d1, d2);
	}

	public EntityStickyDynamite(World world, EntityLivingBase entityliving, int i) {
		this(world);
	...
	public ItemStack getPickupItem() {
		return new ItemStack(ItemsRegistry.sticky_dynamite, 1);
	}
