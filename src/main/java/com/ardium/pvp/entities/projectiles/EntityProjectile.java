package com.ardium.pvp.entities.projectiles;
...
public class EntityProjectile extends EntityArrow implements IThrowableEntity 
{
	...
	public void onEntityUpdate() {
		...
		Vec3 vec3d1 = Vec3.createVectorHelper(this.posX + this.motionX, this.posY + this.motionY,
		...
		if (movingobjectposition != null) {
			vec3d1 = Vec3.createVectorHelper(movingobjectposition.hitVec.xCoord, movingobjectposition.hitVec.yCoord,
		...
		if (getIsCritical()) {
			for (int i1 = 0; i1 < 2; i1++) {
				this.worldObj.spawnParticle("crit", this.posX + this.motionX * i1 / 4.0D,
		...
		if (isInWater()) {
			...
			for (int i1 = 0; i1 < 4; i1++) {
				float f6 = 0.25F;
				this.worldObj.spawnParticle("bubble", this.posX - this.motionX * f6, this.posY - this.motionY * f6,
	...
	public void applyEntityHitEffects(Entity entity) {
		...
		if ((entity instanceof EntityLivingBase)) {
			...
			if (this.knockBack > 0) {
				float f = MathHelper.sqrt_double(this.motionX * this.motionX + this.motionZ * this.motionZ);
				if (f > 0.0F) {
					entity.addVelocity(this.motionX * this.knockBack * 0.6D / f, 0.1D,
							this.motionZ * this.knockBack * 0.6D / f);
				}
			}
			...
			if (((this.shootingEntity instanceof EntityPlayerMP)) && (this.shootingEntity != entity)
	...
	public void onCollideWithPlayer(EntityPlayer entityplayer) {
		if ((this.inGround) && (this.arrowShake <= 0) && (canPickup(entityplayer)) && (!this.worldObj.isRemote)) {
