package com.ardium.pvp.renders.dynamite;
...
public class RenderStickyDynamite extends Render
{	
	  public void renderDynamite(EntityStickyDynamite entityarrow, double d, double d1, double d2, float f, float f1)
	  {
	  ...
	  {
	    renderDynamite((EntityStickyDynamite)entity, d, d1, d2, f, f1);
	  }
	  
	  protected ResourceLocation getEntityTexture(Entity entity)
	  {
	    return WeaponDamageSource.Textures.STICKY_DYNAMITE;
	  }
	}
