...
public class InventoryBackpack implements IInventory {
	...
	public String getInventoryName() {
		return References.MOD_ID + ".container." + ItemBackpack.NAME;
	}
	...
	public boolean isItemValidForSlot(int index, ItemStack stack) {
		return !(stack.getItem() instanceof ItemBackpack)
				...
				|| !(stack.getItem().getUnlocalizedName().toLowerCase().contains("back"))
				|| !(stack.getItem().getUnlocalizedName().toLowerCase().contains("pack"))
